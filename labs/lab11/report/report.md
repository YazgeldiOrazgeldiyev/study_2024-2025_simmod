...
![Запуск системы обработки заявок в очереди](image/11.jpg){#fig:010 width=70%}
...
![График изменения задержки в очереди](image/14.jpg){#fig:014 width=70%}
...
![Файл Queue_Delay_Real.log](image/16.jpg){#fig:016 width=70%}
